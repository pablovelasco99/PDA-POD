...
## PUESTA EN MARCHA
Para poder utilizar este programa tendremos que seguir los siguientes pasos:
...
1. Carpeta **DB**: Aquí encontramos los archivos necesarios para la creación de tablas y conexión con la base de datos.
...
3. Carpeta **FUNCTIONS**: En esta carpeta encontramos el archivo **functions.php**, el cual se encarga de extraer toda la información de los archivos mediante diferentes métodos de selección, que serán explicados a continuación:
    * **parseTitulacion**: Esta función se encarga de devolver un array con la titulación, el campus y el código de la titulación.
...
4. Carpeta **MODEL**: En esta carpeta se encuentran las clases para cada tabla de la base de datos. En todas se realizan las mismas operaciones, así que lo explicaré para el archivo **AREA_Model.php**.
    * Estos archivos están formados principalmente por:
        ...
        * Una función ADD: esta función se encarga de generar una consulta. Esta consulta le asigna a los atributos de la tabla de la base de datos los valores de los atributos de esta clase.
        ...
        * **TRIM**: Esta función genera una consulta con la que se eliminan los espacios en blanco antes y después del atributo.
        * **CHANGE_LINEBREAKS**: Esta función genera una consulta con la que se sustituyen los saltos de línea por un espacio en blanco dentro de todos los campos.
